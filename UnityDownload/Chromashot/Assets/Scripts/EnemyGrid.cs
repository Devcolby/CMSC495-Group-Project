...
public class EnemyGrid : MonoBehaviour
{
    ...
    {
        GameObject boss = Instantiate(bossPrefab, startingPosition + new Vector3(0, 4, 0), Quaternion.identity);
    ...
    void FireMissile()
    {
        if (!paused)
        {
            ...
            {
                powerUpSpawner.SpawnNewPowerUp();
            }
        }
    }
